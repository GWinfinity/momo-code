...
export class Auth extends Effect.Service<Auth>()("Auth", {
  effect: Effect.gen(function* () {
    ...
    const resolveCredentials = (
      ...
      Effect.gen(function* () {
        ...
        const envKeyMap: Record<string, string> = {
          ...
          zhipu: "MOMO_ZHIPU_API_KEY",
          minimax: "MOMO_MINIMAX_API_KEY",
          moonshot: "MOMO_MOONSHOT_API_KEY",
          stepfun: "MOMO_STEPFUN_API_KEY",
          doubao: "MOMO_DOUBAO_API_KEY",
          custom: "MOMO_CUSTOM_API_KEY",
          llmgateway: "MOMO_LLMGATEWAY_API_KEY",
     ...
     */
    const hasCredentials = (providerName: string): Effect.Effect<boolean> =>
      Effect.gen(function* () {
    ...
    const requireCredentials = (
      providerName: string,
    ): Effect.Effect<ProviderCredentials, Error> =>
      Effect.gen(function* () {
        const creds = yield* resolveCredentials(providerName)
        if (creds === null) {
