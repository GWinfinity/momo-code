...
export function renderHelp(): string {
  ...
  lines.push(`  ${C.c}momo${C.B}                         Start interactive chat (REPL)`)
  lines.push(`  ${C.c}momo <prompt>${C.B}                Single-turn coding session`)
  lines.push(`  ${C.c}momo web${C.B}                     Open web dashboard in browser`)
  lines.push(`  ${C.c}momo /setup${C.B}                  Interactive setup wizard (first-time config)`)
  ...
  lines.push("")
  lines.push(`${C.b}CONFIG FILE:${C.B}`)
  lines.push(`  ${C.c}~/.momo/momo.jsonc${C.B}             Persistent config (API keys, provider, model)`)
  lines.push(`  Run ${C.g}momo /setup${C.B} to create interactively, or edit manually.`)
  lines.push("")
  ...
  lines.push(`  1. Run setup wizard:  ${C.g}momo /setup${C.B}`)
  lines.push(`  2. Start chatting:    ${C.g}momo${C.B}`)
  lines.push(`  Or web dashboard:     ${C.g}momo web${C.B}`)
  lines.push("")
